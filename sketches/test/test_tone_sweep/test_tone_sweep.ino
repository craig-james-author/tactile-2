...
This is a modified version of the tone_sweep app that comes with the Arduino software
for Teensy. This version repeats the tone sweep indefinitely rather than doing it
once and quitting.
